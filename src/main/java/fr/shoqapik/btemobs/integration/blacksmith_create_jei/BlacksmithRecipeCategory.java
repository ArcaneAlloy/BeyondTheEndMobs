...
public class BlacksmithRecipeCategory implements IRecipeCategory<BlacksmithRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(BteMobsMod.MODID, "blacksmith");
    ...
    public BlacksmithRecipeCategory(IGuiHelper helper){
    ...
    @Override
    public RecipeType<BlacksmithRecipe> getRecipeType() {
        return JEIBlacksmithPlugin.BLACKSMITH_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.literal("Blacksmith Anvil");
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder iRecipeLayoutBuilder, BlacksmithRecipe blacksmithRecipe, IFocusGroup iFocusGroup) {
