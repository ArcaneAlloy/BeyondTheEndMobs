...
public class DruidRecipe implements Recipe<SimpleContainer> {
    ...
    public DruidRecipe(ResourceLocation id, ItemStack craftedItem, Ingredient ingredient, int tier) {
        this.id=id;
    ...
    public boolean matches(SimpleContainer p_44002_, Level p_44003_) {
        ...
        int countItemValid=0;
        for(int i = 0 ; i < 6 ; i++){
            ItemStack stack = p_44002_.getItem(i);
            if(isValid(stack)){
                countItemValid++;
            }
        }
    ...
    public RecipeSerializer<?> getSerializer() {
        return BteMobsRecipeSerializers.DRUID_RECIPE.get();
    }

    @Override
    public RecipeType<?> getType() {
        return BteMobsRecipeTypes.DRUID_RECIPE_TYPE.get();
    }

    public static class Serializer implements RecipeSerializer<DruidRecipe> {
        public DruidRecipe fromJson(ResourceLocation p_44562_, JsonObject p_44563_) {
            ...
            return new DruidRecipe(p_44562_,result, ingredients,tier);
        }
        ...
        public DruidRecipe fromNetwork(ResourceLocation p_44565_, FriendlyByteBuf p_44566_) {
            Ingredient ingredients = Ingredient.fromNetwork(p_44566_);
            int tier = p_44566_.readInt();
            ItemStack result = p_44566_.readItem();
            return new DruidRecipe(p_44565_,result,ingredients,tier);
        }
